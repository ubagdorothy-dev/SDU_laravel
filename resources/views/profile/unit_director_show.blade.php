...
@section('title', 'Profile - Unit Director')
    ...
    <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('directory_reports.index') }}">
                            <i class="fas fa-users"></i> Directory & Reports
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('training_assignments.index') }}">
        ...
        <main role="main" class="col-md-10 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="readonly-note">
                ...
                <strong>Note:</strong> As a Unit Director, your profile information is managed by the system administrator. 
                ...
                <div class="col-md-6">
                    <div class="profile-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="profile-info-value">{{ ucfirst(str_replace('_', ' ', $user->role)) }}</div>
